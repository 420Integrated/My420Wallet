    ...
    <div v-show="!bityExitToFiat">
      ...
      <div class="form-content-container">
          ...
          <div class="form-block amount-to-address">
            <div class="amount">
              ...
              <div class="error-message-container">
                ...
                <p v-if="smokeNotice && fromCurrency === 'FOURTWENTY'">
                  {{ $t('swap.warning.not-enough-fourtwenty-smoke') }}
                </p>
                <p v-if="smokeNotice && fromCurrency !== 'FOURTWENTY'">
        ...
        <div class="fee-notice">
          <span v-if="smokeNotice && fromCurrency === 'FOURTWENTY'">
            {{ $t('swap.warning.not-enough-fourtwenty-smoke') }}</span
          >
          <span v-if="smokeNotice && fromCurrency !== 'FOURTWENTY'">
...
export default {
  ...
  computed: {
    ...
    validSwap() {
      ...
      if (this.smokeNotice) return false;
      const canExit =
